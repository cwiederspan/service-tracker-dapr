...
class BingMap {
    ...
    constructor() {
        ...
        console.log("BingMap.ctor()...");

        this.map = new Microsoft.Maps.Map('#myMap', {
            center: new Microsoft.Maps.Location(40.0, -105.0),
...
function addPushpin(sitePin: BingPin): void {
    ...
    const pushpin = new Microsoft.Maps.Pushpin(sitePin.location, {
